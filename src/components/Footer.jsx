  ...
  return (
    <div>
        <div className='flex gap-5 w-full h-screen bg-zinc-900 p-20'>
            <div className='w-1/2 h-full flex flex-col justify-between font-[Bebas]'>
                <div className='heading'>
                <h1 className='text-[10vw] uppercase leading-none -mb->1 tracking-tight'>Eye-</h1>
                <h1 className='text-[10vw] uppercase leading-none -mb->1 tracking-tight'>Opening</h1>
                </div>
                <h3>
        ...
        <div className='w-1/2'>
        <h1 className='text-[6vw] uppercase leading-none -mb->1 tracking-tighter'>
            Presentations

        </h1>
        <div className='dets font-[Bebas] ml-10'>
